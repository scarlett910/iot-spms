...
import { invoices, users, pricingPolicy, User } from "@/data/mock"
                ...
                {myInvoices.map(inv => {
                  ...
                  return (
                    <button
                      ...
                      className="w-full text-left border border-gray-100
                                 rounded-xl p-4 hover:border-[#185FA5]/30
